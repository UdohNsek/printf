 ...
 * @width: get width.
 * @precision: precision to specify
...
/**
 * write_unsgnd - Display an unsigned number
 * @is_negative: Number showing if the number is -tive.
 * @ind: Index at which the number starts.
 * @buffer: Array of characters
 * @flags: get Flags to specify
 * @width: get Width to specify
 * @precision: Precision to specify
 * @size: Size to specify
 *
