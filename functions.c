...
/**
 * print_char - Makes it possible to Prints a char
 * @types: its a List a of arguments
 * @buffer: Buffer array to handle print
 * @flags:  it help Calculates active flags
 * @width: the Width
...
/************************* IT PRINT A STRING *************************/
/**
 * print_string - Enables Printing of a string
